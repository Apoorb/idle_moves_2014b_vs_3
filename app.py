...
erlt_df_2014b_3 = pd.read_csv("data/idling_mvs_2014b_3.csv", index_col=0)
rename_map = {
    "moves": "MOVES",
    "year_id": "Year",
    "month": "Month",
        ...
        html.Div(
            ...
            children=[
                html.Div(
                    ...
                    children=[
                        html.H1(
                            "MOVES 2014b  vs. MOVES 3 Idling Emission " "Comparison"
                        ),
                        dcc.Dropdown(
...
def update_line_chart(sut_val, fuel_val, pollutant_val):
    max_em = erlt_df_2014b_3_1.loc[
        lambda df: (df.Pollutant == pollutant_val), "Idling Emission Rate (grams/hour)"
    ].values.max()
